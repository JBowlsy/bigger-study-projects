...
class Drunk(Pokescum):
    ...
    def __init__(self, name, element, health, speed):
        ...
        self.moves = ['Can Toss','Headbutt', 'S***', 'Tongue biter'] #light attack, heavy attack, recover, special move
    ...
    def move_info(self):
        ...
        print("S***: Recovery (15-25: health points)")
...
class Grease(Pokescum):
    ...
    def __init__(self, name, element, health, speed):
        super().__init__(name, element, health, speed)
        self.moves = ['Flying fox', 'Big Badger', 'Urinal Cakes', 'Collapse'] #light attack, heavy attack recover, special move
    ...
    def move_info(self):
        ...
        print("Collapse: Special attack (?: hit points)")

class Tank(Pokescum):
    """Third element 'Tank' in the pokescum (child class)"""
    def __init__(self, name, element, health, speed):
        super().__init__(name, element, health, speed)
        self.moves = ['Rat trap', 'Spew', 'P***', 'Consume'] #light attack, heavy attack recover, special move
    ...
    def move_info(self):
        ...
        print("P***: Recovery (15-25: health points)")
        print("Consume: Special attack (?: hit points)")
...
class Game():
    ...
    def __init__(self):
        ...
        self.pokescum_names = ['Fallwell', 'Catweasel', 'Walrus', 'Sellswood', 'Hobo', 'Coyote', 'Phantom', 'Rocky Balboa']
        self.battles_won = 0
